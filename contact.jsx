        ...
        <div className="bg-white border border-slate-100 rounded-3xl shadow-sm p-8 lg:p-12 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <a
              ...
              <Icon name="video" size={18} /> Confirm on Zoom
            </a>
            <button onClick={downloadIcs} className="px-6 py-3 border border-slate-200 text-ink font-semibold rounded-lg hover:border-teal2 hover:text-teal1 transition flex items-center gap-2">
